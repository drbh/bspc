...
mod tests {
    ...
    fn test_validate_array_bounds() {
        ...
        // Invalid alignments
        assert_eq!(validate_array_bounds::<u32>(15), Err(BspcError::ArrayAlignment));
        assert_eq!(validate_array_bounds::<u64>(23), Err(BspcError::ArrayAlignment));
    ...
    fn test_validate_alignment() {
        ...
        assert_eq!(validate_alignment::<u64>(unaligned_ptr), Err(BspcError::ArrayAlignment));
    }
}